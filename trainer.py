...
def inference(args, model, best_performance):
    db_test = Queens_dataset(base_dir=args.volume_path, split="val_vol", list_dir=args.list_dir, nclass=args.num_classes)
...
def trainer_queens(args, model, snapshot_path):
    ...
    db_train = Queens_dataset(base_dir=args.root_path, list_dir=args.list_dir, split="train", nclass=args.num_classes,
