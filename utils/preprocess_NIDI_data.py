...
for split in splits:
    if(split == 'train'):
        ct_path = './data/NIDI/Abdomen/RawData/TrainSet/img' # set your path to your trainset directory
        seg_path = './data/NIDI/Abdomen/RawData/TrainSet/label'
        save_path = './data/NIDI/train_npz_new/'
    else:
        ct_path = './data/NIDI/Abdomen/RawData/TestSet/img' # set your path to your testset directory
        seg_path = './data/NIDI/Abdomen/RawData/TestSet/label'
        save_path = './data/NIDI/test_vol_h5_new/'
