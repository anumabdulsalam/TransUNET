...
from trainer import trainer_queens
from lib.networks import MIST_CAM
...
parser.add_argument('--root_path', type=str,
                    default='./data/NIDI/train_npz_new', help='root dir for data')
parser.add_argument('--volume_path', type=str,
                    default='./data/NIDI/val_vol_h5_new', help='root dir for validation volume data')
